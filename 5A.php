          ...
          <!-- <div class="form-group"> -->
            <div class="row form-row mb-1">
              ...
              <div class="col-md-4">
                ...
                <p class="text-center">
                    Pilih Kelas
          <a class="btn btn-primary btn-block " href="5A.php">5A</a>
          <a class="btn btn-primary btn-block active" href="page_dosen.php">5B</a></p>
                </div>
              </div>
            </div><hr>
...
$sql = "select * from mahasiswa where kelas = '5A' order by nim ";
